            ...
            <div className="text-center mb-8">
              ...
              >
                ...
                <img 
                  ...
                  onError={(e) => { (e.target as HTMLImageElement).src = "https://api.dicebear.com/7.x/avataaars/svg?seed=Profesor"; }}
                />
                <button 
                ...
                >
                  <div className="mt-4 p-4 bg-yellow-50 rounded-lg text-sm text-yellow-900 border-2 border-yellow-200 text-left">
                    <ul className="list-disc list-inside space-y-1 font-medium">
                      <li>🐷 Mueve el cerdito para atrapar dinero.</li>
                      <li>📈 <strong>¡Supera los 50 niveles!</strong></li>
                      <li>🏆 Lee cada tip para ganar la insignia final.</li>
                    </ul>
                  </div>
                </motion.div>
              )}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            ...
            >
              <div className="bg-pink-600 p-4 text-white text-center relative overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full opacity-20" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 10px, #fff 10px, #fff 20px)' }} />
                <h2 className="text-xl font-bold relative z-10">Validación Académica</h2>
                <button onClick={() => setShowInfoModal(false)} className="absolute top-1/2 -translate-y-1/2 right-4 text-white/80 hover:text-white hover:bg-white/20 rounded-full p-1 transition-colors z-20">
                  <X size={24} />
                </button>
              </div>
              ...
              <div className="p-6 text-center">
                ...
                <div className="space-y-3">
                  <a href="https://www.researchgate.net/profile/A-Ortiz-Ramirez" target="_blank" rel="noopener noreferrer" className="block">
                    <div className="flex items-center p-3 bg-green-50 border-2 border-green-200 rounded-xl hover:bg-green-100 transition-colors group cursor-pointer">
                      <div className="bg-green-500 text-white p-2 rounded-lg mr-3 group-hover:scale-110 transition-transform"><GraduationCap size={20} /></div>
                      <div className="text-left"><div className="text-xs text-green-600 font-bold uppercase">Perfil Académico</div><div className="text-sm font-bold text-gray-800">ResearchGate</div></div>
                    </div>
                  </a>

                  <a href="https://orcid.org/0000-0002-3698-2873" target="_blank" rel="noopener noreferrer" className="block">
                    <div className="flex items-center p-3 bg-blue-50 border-2 border-blue-200 rounded-xl hover:bg-blue-100 transition-colors group cursor-pointer">
                      <div className="bg-blue-500 text-white p-2 rounded-lg mr-3 group-hover:scale-110 transition-transform"><Fingerprint size={20} /></div>
                      <div className="text-left"><div className="text-xs text-blue-600 font-bold uppercase">Identificador ORCID</div><div className="text-sm font-bold text-gray-800">0000-0002-3698-2873</div></div>
                    </div>
                  </a>

                  <a href="https://ambrosioortizramirez.link" target="_blank" rel="noopener noreferrer" className="block">
                    <div className="flex items-center p-3 bg-purple-50 border-2 border-purple-200 rounded-xl hover:bg-purple-100 transition-colors group cursor-pointer">
                      <div className="bg-purple-500 text-white p-2 rounded-lg mr-3 group-hover:scale-110 transition-transform"><Globe size={20} /></div>
                      <div className="text-left"><div className="text-xs text-purple-600 font-bold uppercase">Sitio Web</div><div className="text-sm font-bold text-gray-800">ambrosioortizramirez.link</div></div>
                    </div>
                  </a>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-3 border-t text-center">
                <button onClick={() => setShowInfoModal(false)} className="text-sm text-gray-500 hover:text-gray-800 font-medium underline">
